...
alias volatility='volatility2docker volatility'
# --------------------------------- ALIASES -----------------------------------
alias log='adb logcat -c && adb shell logcat | grep "chromium":'
alias xflux='xflux -l 46.95 -g 4.3'
#alias ..='cd ..'
alias cp='cp -v'
alias rm='rm -I'
alias mv='mv -iv'
...
PATH=$HOME/Cordova/Android/cmdline-tools/bin/:$PATH
PATH=$HOME/Cordova/Android/platform-tools/:$PATH
PATH=$HOME/Cordova/Gradle/gradle-7.5/bin:$PATH
export ANDROID_SDK_ROOT=$HOME/Cordova/Android/
export ANDROID_HOME=path/to/android/sd
PATH=$HOME/.factorio/bin/x64/:$PATH
PATH=$HOME/.clangd/bin/:$PATH
